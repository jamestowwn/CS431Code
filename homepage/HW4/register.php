  ...
  if (isset($_POST['userName'])) { 
    ...
    //lastly validate password 
      ...
      if ($invalidName == "" && $userTaken == "" && $invalidPass == "") {
        ...
        header("Location: http://ecs.fullerton.edu/~cs431s17/HW4/photoshare.php?loadpage=inbox");
        die();
      }
...
<html>
  <head>
    <title>Image Share Registration</title>
  </head>
  <body>
    <h1>Please register with our image share site or go to the login page:</h1>
    <hr>
