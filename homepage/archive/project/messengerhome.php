<?php
  ...
  $displayHeader .= '<td><a href="./register.php">Register</a></td></tr>';
  ...
  if ((isset($_SESSION['userid']) && $_SESSION['userid'] != "") || isset($_GET['loadpage'])) {
    ...
    switch ($loadpage) {
      ...
      case "pushpostchange":
        ...
        if ($displayError == "" && $displayHTML == "") {
          if (isset($_GET['threadid'])) {
            ...
            $displayError = "Error reloading thread page, please return to 'View Forums'";
          }
        }
        break;
      ...
      case "pushthreadchange":
        ...
        if ($displayError == "" && $displayHTML == "") {
          if (isset($_GET['threadid'])) {
            header("Location: http://ecs.fullerton.edu/~cs431s17/project/messengerhome.php?loadpage=threads&&threaid=" . $_GET['threadid']);
            die();
    ...
    if (isset($_SESSION['userid']) && $_SESSION['userid'] != "") {
      ...
      $displayMenu .= '<tr><td><a href="./messengerhome.php?loadpage=compose">Compose Message</a></td></tr>';
      $displayMenu .= '<tr><td><br></td></tr>';
      $displayMenu .= '<tr><td><a href="./messengerhome.php?loadpage=inbox">Inbox</a></td></tr>';
      $displayMenu .= '<tr><td><a href="./messengerhome.php?loadpage=sent">Sent</a></td></tr>';
      $displayMenu .= '<tr><td><br></td></tr>';
    ...
    $displayHTML .= 'You may also browse the forums, but cannot contribute.</font>';
  }
?>
<html>
<head>
...
<table cellpadding="5" cellspacing="0" border="0" windth="700" align="right">
  <?php
